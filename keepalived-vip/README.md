...
```
## Example using notify ans hetzner failover ip

For an example using a notify script to assign failover ip via a notify script see example in `notify-example-hetzner` Folder.
